...
class CNN:
    ...
    def __init__(self):
        ...
        self.parameters = {'filter_sizes': (4, ),
                           'num_filters': 32,
                           'Dense_size': 16,
                           'Dropout': 0.30444,
                           'Activation': 'relu',
    ...
    def Network(self):
        ...
        z = Dropout(self.parameters['Dropout'])(x)
        conv_blocks = []
        for sz in self.parameters['filter_sizes']:
            conv = Convolution1D(filters=self.parameters['num_filters'],
                                 kernel_size=sz,
                                 padding="valid",
                                 activation="relu",
                                 strides=1)(z)
        ...
        z = Dense(self.parameters['Dense_size'], activation=self.parameters['Activation'])(z)
    ...
    def evaluate_on_test(self):
        ...
        np.savetxt(self.__class__.__name__, Y_test_pred)
    ...
    def run_model(self, reTrain=True):
        ...
        # 2, Prep
        callback = [EarlyStopping(min_delta=0.003, patience=4),
    ...
    def run_hyperopt_search(self, n_evals):
        ...
        search_space = {'optimizer': hp.choice('opt', ['adadelta', 'adam', 'rmsprop', 'sgd']),
                        ...
                        'dense': hp.choice('dense_size', [8, 16]),
    ...
    def Kstratified(self, params):
        ...
        self.parameters['Dense_size'] = params['dense']
